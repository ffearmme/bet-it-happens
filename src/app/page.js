...
export default function Home() {
    ...
    return (
        <div className="container animate-fade">
            ...
            {activeTab === 'bets' ? (
                // Maintenance Check for Bets Tab
                (maintenanceSettings?.bets === false && user?.role !== 'admin') ? (
                    <div style={{ padding: '60px 20px', textAlign: 'center', color: '#888', background: 'var(--bg-card)', borderRadius: '12px' }}>
                        <div style={{ fontSize: '48px', marginBottom: '16px' }}>🚧</div>
                        <h2 style={{ color: '#fff', marginBottom: '8px' }}>Tracking Bets...</h2>
                        <p>We are updating the lines. The market will reopen shortly.</p>
                    </div>
                ) : (
                    <>
