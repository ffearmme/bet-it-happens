...
export default function LeaderboardGrid({ limit = 20, showWeekly = true }) {
    const { user, users, getUserStats, getWeeklyLeaderboard } = useApp();
                    ...
                    {displayList.map((player, index) => (
                        <div
                            ...
                            onClick={() => {
                                ...
                                else alert("Login to view player stats!");
                            }}
                            style={{
                                display: 'flex',
